...
- **⚠️ E4 Money-Modell-Glattzug + Mock→Pro-E2E-Härtung (D99) — IN ARBEIT (Anil-Prio 2026-06-24).** Plan-Anker `worklog/notes/366-e4-money-model-cleanup-epic.md`.
  ...
  - **← NÄCHSTER Schritt 3: E2E-Sweep ②IPO→③Poll→④Research→⑤Bounty + Bug-Fixes** (`worklog/notes/365-e2e-findings.md`). Slice-Reihenfolge: **367 T-3 Diamond-Hands** (HIGH: Meme-Wort + Award-on-buy-Logik + Konfetti) → 368 P-4 ipo_price-Data-Drift (Money/CEO) → 369 T-2 push-500 → 370 E2E-Sweep ②–⑤. T-1 leerer Markt = Produkt-Entscheid (eigener Slice).
