...
- **🟡 EINZIGER offener Punkt 385 = AC-12 UI-Playwright post-Deploy:** EventFormModal-Input „Min. Spieler vom eigenen Verein" in beiden Buildern (Platform-Admin `/bescout-admin` DE-hardcoded + Club-Admin `/club/sakaryaspor/admin` t()), 0 Console-Errors, **kein MISSING_MESSAGE** (S333-Falle), Mobile 393px. Login `ali@test.bescout.de`/`123456` (Plattform+Club-Admin). Nach Vercel-Deploy von main.
