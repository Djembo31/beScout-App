...
| 2 — Journey Audits (12) | 🟡 in-progress | Frontend+Backend+Business+Reviewer | J1-J5 ✅. **J6+J7+J8 ✅ Round 1+2 komplett** (2026-04-15): 5 AKUT-P0 LIVE-FIX + 46 autonome Healer-Fixes + Rework (orderCannotBeCancelled, Wording-Sweep, Streak-Migration, J6-4-RPCs-REVOKE) + **Round 2** (J6-AR-50 holdings public-read, AR-53 realtime; J7-AR-53 mission/streak-REVOKE, AR-54 TR-i18n-Schema+Backfill 25 missions, AR-55 streak-description, AR-56 MissionDisclaimer, locale-aware title_tr; J8-AR-53 place_sell_order error-cleanup, AR-54 Orderbuch→Angebots-Tiefe, AR-56 Fee-Breakdown). **Post-Beta Round auch done (2026-04-15 CEO "erst post-beta angehen"):** J7-AR-57 Mission-Scoping Wiki-Doku, J8-AR-55 Rate-Limit Config-Tier (tier-based inline: free=10/20, bronze=15/30, silber=20/50, gold=100/200), J8-AR-57 SellModal DRY-Refactor (SellModalCore + Wrapper, -114 LOC, preventClose+Disclaimer+Fee-Breakdown in beiden). J9+ pending. |
| 3 — Cross-Cutting (4) | 🟡 Audit + AKUT-Fixes done | CTO + 4 Audit-Agents + 3 Healer-Agents | 2026-04-15: DB-Audit (47 Findings, 5 AKUT fixed: captain_slot 12 slots, transactions.type CHECK+Legacy Backfill, platform_settings RLS, open_mystery_box CR→Credits, 5 Admin-RPCs REVOKE anon), i18n-Audit (13 CRITICAL, 12 missing keys + SellModalCore namespace + 47 notifText locale-aware ALL ROLLED OUT), Perf-Audit (Build OK, Money RPCs 10x slow = AMBER closed-Beta OK), Compliance-Audit (29 Violations + 8 Live-DB Rows, $SCOUT/kazan*/bounties-throw sweep, 43 TR kazan*→aldın, Achievement i18n Schema+Backfill). Post-Beta: Money RPC Optimization, Trader/Tüccar Role-Rename DB-Migration. |
