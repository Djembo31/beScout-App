...
- **W0 — DB-Security [§3, Triage fertig]:** ✅ **INV-31 no_guard REVOKE (460, live):** `calculate_fan_rank` + `refund_wildcards_on_leave` (Info-Leak + Wildcard-Self-Farm zu; Reviewer PASS). · ✅ **D-12 DROP (461, live):** `get_club_dashboard_stats(text)` toter v1-Pfad weg (by-name-Enumeration + Duplikat; v2-anon-PII-Exposure bleibt → D-35). · **OFFEN:** D-35 v2-anon-Grant-Entscheid · 2 Recon-RPCs (`security_definer_audit`, `rls_policy_matrix`) admin-only · `anon` REVOKE-Hygiene (9 Trigger + ~10 Kalkulatoren + 3 Leaderboard-RPCs) · 81 permissive Policies mergen + 26 unused Index + 51 FK-Index. *(Verifiziert: kein aktiver Leak.)*
