...
- **E-3-Regel-Erweiterungen** (je winziger Folge-Slice, kein Schema-Change):
  ...
  - offen: `nation_in`/max-pro-Nation (Daten: nationality 95,5%) · `mv_max_eur` (Underdog; MV 86,4%, Null-Edge entscheiden) · `position_quota` (position 100%, 4 Werte). Builder bekommt „Bedingung hinzufügen ▾" + Echtzeit-Treffer-Anzeige (§3b).
