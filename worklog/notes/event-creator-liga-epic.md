...
- **E-3-Regel-Erweiterungen** (je winziger Folge-Slice, kein Schema-Change):
  ...
  - offen: `nation_in`/max-pro-Nation (Daten: nationality 95,5%) · `mv_min_eur` (Star-Event, Spiegel) · `max_per_position` (Spiegel 388). Builder bekommt „Bedingung hinzufügen ▾" + Echtzeit-Treffer-Anzeige (§3b).
