...
- **← OFFEN: letzte Quelle** (eigener Slice, gleiches Inline-Muster): Bounty `approve_bounty_submission`→'bounty' (heute gar nicht notiert, Differenz reward−creator_net — Body genau lesen, evtl. erst berechnen).
