...
- **← OFFEN: restliche Quellen** (je eigener Slice, gleiches Inline-Muster): Research `unlock_research`→'research' · Bounty `approve_bounty_submission`→'bounty' (heute gar nicht notiert, Differenz reward−creator_net).
