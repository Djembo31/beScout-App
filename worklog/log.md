...
- **Proof:** `worklog/proofs/369-push-vapid.txt` — tsc clean, 9 Tests grün (sanitize 7 + Fail-Safe 2: no-throw + capture-once), Prod-Pull pre/post-Heal. AC5 (Post-Deploy Buy ≠ 500) nach Deploy.
