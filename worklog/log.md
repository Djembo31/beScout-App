...
- Stage-Chain: SPEC (`specs/404-…`, L UI) → IMPACT skipped (Consumer in Spec §3 gegreppt, kein RPC) → BUILD (1 NEU + 6 EDIT + 3 Tests) → REVIEW reviewer-Agent **PASS** (`reviews/404-review.md`, 1 NIT+1 INFO) → PROVE (vitest 298 + tsc 0; **UI-Playwright post-Deploy offen**) → LOG.
