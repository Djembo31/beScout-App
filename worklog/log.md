...
- Files: src/lib/services/offers.ts · offers.test.ts · supabase/migrations/20260627230000_open_bids_exclude_own_dashboard.sql · trading.md. Commit: <hash>. **⏳ Live-UI-Verify (Gebot fehlt in „Offene Gebote", da in „Ausgehend" mit Storno) nach Deploy.**
