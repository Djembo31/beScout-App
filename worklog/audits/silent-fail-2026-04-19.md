...
- `src/app/api/cron/gameweek-sync/route.ts:1248` [HIGH] — .in('club_id', allLeagueClubIds);
- `src/app/api/cron/gameweek-sync/route.ts:1282` [HIGH] — .in('home_club_id', allLeagueClubIds);
- `src/app/api/cron/gameweek-sync/route.ts:1366` [HIGH] — .in('event_id', eventIds);
- `src/app/api/cron/gameweek-sync/route.ts:1443` [HIGH] — .in('home_club_id', allLeagueClubIds);
- ... +88 more
