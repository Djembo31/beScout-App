...
- `src/features/fantasy/services/events.mutations.ts:307` [MEDIUM] — .in('id', eventIds);
- `src/features/fantasy/services/events.queries.ts:39` [MEDIUM] — .in('club_id', clubIds)
- ... +68 more

## Pattern: error-check-without-throw-or-return (44 findings)
...
- `src/lib/services/players.ts:261` [MEDIUM] — if (error) return { success: false, error: error.message };
