...
## Pattern: in-without-chunking (118 findings)
...
## Pattern: error-check-without-throw-or-return (48 findings)
...
- `src/lib/services/players.ts:262` [MEDIUM] — if (error) return { success: false, error: error.message };
...
## Pattern: silent-catch-arrow-fallback (1 findings)

- `src/components/player/detail/hooks/usePlayerTrading.ts:535` [MEDIUM] — // leere .catch(() => {})" + common-errors.md §1 / §5.
