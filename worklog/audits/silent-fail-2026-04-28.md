...
- `src/features/fantasy/services/events.queries.ts:133` [MEDIUM] — query = query.in('type', filters.type);
- `src/features/fantasy/services/fixtures.ts:198` [MEDIUM] — .in('fixture_id', fixtureIds)
- `src/features/fantasy/services/fixtures.ts:232` [MEDIUM] — .in('fixture_id', fixtureIds)
- ... +49 more
