...
Anil trägt Business-Perspektive explizit. Claude nimmt diese Perspektive ein NACH Spec, VOR Build.
...
### 4. Compliance-Risk?
Check gegen `.claude/rules/business.md`:
...
- Performance-Opinion → `.claude/rules/performance.md`
