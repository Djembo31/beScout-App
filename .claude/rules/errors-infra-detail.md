...
# Der Navigator in errors-infra.md (always-loaded bei Infra-Edit) zeigt die Regel inline;
...
# Errors: Infra — Detail (on-demand)

Stand: 2026-04-24 · Split aus `common-errors.md` (Slice 186) · Slice 353: Detail-Auslagerung aus dem Navigator (`errors-infra.md`). Siehe auch `performance.md`.

> **Einstieg:** Du landest hier, weil ein Navigator-Eintrag in `errors-infra.md` auf einen dieser Abschnitte zeigt. Springe zum benannten Abschnitt (« Heading »). Die Reihenfolge der Abschnitte ist identisch mit dem Navigator.
