...
- [Decisions-Log D1–D96](../../memory/decisions.md) — consult_when: warum-Entscheidung, ADR-Historie, Scope/Architektur/Prozess-Begründung, „warum nicht anders" (D96: Plattform-Treasury fängt verbrannte Plattform-Fees auf + finanziert Plattform-Rewards)
