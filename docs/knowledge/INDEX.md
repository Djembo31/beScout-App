...
- [Decisions-Log D1–D95](../../memory/decisions.md) — consult_when: warum-Entscheidung, ADR-Historie, Scope/Architektur/Prozess-Begründung, „warum nicht anders" (D95: große Rule-Files = Navigator+Detail on-demand)
