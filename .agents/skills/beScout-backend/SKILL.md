...
1. `.Codex/rules/common-errors.md` — Top-Fehler (automatisch geladen)
2. `.Codex/rules/database.md` — Schema, RLS, CHECK Constraints
3. `.Codex/rules/business.md` — Fee-Splits, Licensing-Phasen
