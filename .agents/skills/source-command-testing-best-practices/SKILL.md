---
name: "source-command-testing-best-practices"
description: "Command from Testing Toolkit"
---

# source-command-testing-best-practices

Use this skill when the user asks to run the migrated source command `testing-best-practices`.
