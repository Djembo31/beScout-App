...
1. `AGENTS.md` — Design Tokens, Component Registry, Import Map
2. `.Codex/rules/common-errors.md` — CSS Traps, React/TypeScript Section
3. `.Codex/rules/performance.md` — Query Performance, React Rendering
4. `LEARNINGS.md` in diesem Ordner — echte Bugs aus 91 Sessions
5. Bei neuem Component: AGENTS.md Component Registry ZUERST pruefen
...
### Components
- Component Registry in AGENTS.md ZUERST pruefen
