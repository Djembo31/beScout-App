...
| `.Codex/rules/<errors-X>.md` | Bekannte Fallen für DIESE Domain | Welche Pattern gilt für DIESEN Slice? |
...
**Anti-Pattern:** "Code-Reading-Liste = `AGENTS.md` und `workflow.md`". Das sind Globals die der Agent eh kennt. **Slice-spezifische Files sind Pflicht** — gerade die Files die der Agent IM SPEC zitiert oder verändert.
