---
name: "source-command-security-best-practices"
description: "Command from Security Essentials"
---

# source-command-security-best-practices

Use this skill when the user asks to run the migrated source command `security-best-practices`.

## Command Template

# Security Best Practices for Codex

## Overview
This guide provides essential security practices when using Codex in your projects.
...
Codex-setup add security-essentials
...
Always review code changes suggested by Codex, especially:
