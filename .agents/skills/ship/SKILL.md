...
1. **Pre-Edit-Checks** aus `AGENTS.md` durchgehen (RPC NULL, CHECK constraints, RLS, Return-Shape, Mobile 393px, Hooks vor Returns, etc.).
...
1. **reviewer-Agent dispatchen** — Prompt:
   ...
   Agent({
     ...
     prompt: "Lies worklog/specs/NNN-*.md und git diff fuer Slice NNN.
              Pruefe gegen .Codex/rules/common-errors.md, memory/patterns.md,
...
4. Wenn Bug gefixt: neue Regel in `.Codex/rules/common-errors.md`.
...
- `.Codex/rules/common-errors.md` — Pattern-Datenbank
- `AGENTS.md` — Pre-Edit-Checks, Stack, Top-Regeln
