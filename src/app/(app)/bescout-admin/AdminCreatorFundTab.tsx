    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <Card className="p-4">
          ...
          <div className="text-lg font-mono font-black text-cyan-400 tabular-nums">{fmtScout(centsToBsd(stats?.totalPaid ?? 0))} bCredits</div>
        </Card>
        <Card className="p-4">
        ...
        <Card className="p-4">
          ...
          <div className="text-lg font-mono font-black text-lime-400 tabular-nums">{fmtScout(centsToBsd(adStats?.totalPaid ?? 0))} bCredits</div>
        </Card>
        <Card className="p-4">
              ...
              <tbody>
                {stats.recentPayouts.map(p => (
                  <tr key={p.id} className="border-b border-white/[0.04]">
                    ...
                    <td className="py-1.5 px-2 text-right font-mono text-green-500 font-bold tabular-nums">{fmtScout(centsToBsd(p.payout_cents))} bCredits</td>
