...
export default function BescoutAdminError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] p-4">
      <Card className="max-w-md w-full p-8 text-center space-y-4">
        ...
        <h2 className="text-xl font-black text-balance">{tc('errorTitle')}</h2>
        <p className="text-sm text-white/50 text-pretty">{tc('errorDesc')}</p>
