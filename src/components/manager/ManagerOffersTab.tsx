        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 text-sm mb-2">
            ...
            <span className="font-mono font-bold tabular-nums text-gold">
              {fmtScout(centsToBsd(offer.price))} bCredits
            </span>
            <span className="text-white/30">&bull;</span>
        ...
        <Modal open={true} onClose={() => { setCounterModal(null); setCounterPrice(''); }} title={t('counterOffer')}>
          <div className="space-y-4">
            <div className="text-sm text-white/60">
              {t('originalPrice')} <span className="font-mono tabular-nums text-gold">{fmtScout(centsToBsd(counterModal.price))} bCredits</span> — {counterModal.player_first_name} {counterModal.player_last_name}
            </div>
            <div>
