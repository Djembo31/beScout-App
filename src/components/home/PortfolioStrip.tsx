        ...
        {top6.map((h) => {
          ...
          return (
            <Link
              ...
              className={cn(
                'flex-shrink-0 w-[130px] bg-surface-base border border-white/[0.10] rounded-xl p-3 card-lift group relative overflow-hidden card-metallic',
              )}
              style={{
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-mono font-black gold-glow">
                  {fmtScout(h.floor)}
                </span>
                <span className={cn(
              ...
              <div className="text-[10px] text-white/30 mt-1 font-mono">{h.qty} SC</div>
            </Link>
          );
        })}
        {holdings.length > 6 && (
