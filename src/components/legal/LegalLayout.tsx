  ...
  return (
    <div className="min-h-dvh bg-bg-main text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-10 md:py-16">
        <h1 className="text-2xl md:text-3xl font-black text-balance mb-8">{title}</h1>
        <div className="prose-legal space-y-8 text-white/70 text-sm text-pretty leading-relaxed">
          {children}
        </div>
      </main>
