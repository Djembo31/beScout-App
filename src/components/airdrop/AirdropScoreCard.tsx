        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5">
              <span className="text-xs font-bold text-white/50 uppercase">bCredits Airdrop</span>
              <span
    ...
    <Card className="p-4 bg-purple-500/[0.04] border-purple-500/15">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-bold text-white/50 uppercase">bCredits Airdrop Score</span>
        </div>
        <span
