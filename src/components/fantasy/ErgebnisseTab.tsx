    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 gap-2">
        <button
          ...
          className="flex items-center justify-center gap-2 p-3 bg-white/[0.03] border border-white/[0.08] rounded-xl hover:bg-white/[0.06] transition-colors active:bg-white/[0.08] min-h-[44px]"
        >
