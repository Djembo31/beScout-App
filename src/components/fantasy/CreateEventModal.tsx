      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-green-500/10 rounded-xl border border-green-500/20">
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            <div>
              <div className="font-mono font-bold text-lg text-gold tabular-nums">{buyIn} bCredits</div>
              <div className="text-xs text-white/40">{t('entryLabel')}</div>
            </div>
            <div>
              <div className="font-mono font-bold text-lg text-purple-400 tabular-nums">{prizePool} bCredits</div>
              <div className="text-xs text-white/40">{t('prizeMoney')}</div>
            </div>
            <div>
              <div className="font-mono font-bold text-lg text-white/60 tabular-nums">{creatorFee} bCredits</div>
