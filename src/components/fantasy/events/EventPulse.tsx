  ...
  return (
    <Card surface="elevated" className="rounded-2xl overflow-hidden">
      <div className="grid grid-cols-2 sm:grid-cols-4">
        ...
        {/* Open */}
        <div className="p-3 text-center sm:border-r sm:border-white/[0.06]">
        ...
        {/* LIVE */}
        <div className={`p-3 text-center border-t border-r border-white/[0.06] sm:border-t-0 ${liveCount > 0 ? 'status-live' : ''}`}>
        ...
        {/* Joined */}
        <div className={`p-3 text-center border-t border-white/[0.06] sm:border-t-0 ${joinedCount > 0 ? 'bg-gold/[0.03]' : ''}`}>
