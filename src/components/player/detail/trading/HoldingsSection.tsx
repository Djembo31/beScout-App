                    ...
                    <div className="mt-1.5 space-y-1">
                      <div className="flex items-center gap-1.5">
                        <button onClick={() => setSellPriceBsd(floorBsd.toString())}
                          className="px-2.5 py-1.5 min-h-[44px] rounded-lg bg-surface-base border border-white/10 text-[10px] font-bold text-white/50 hover:text-white hover:bg-white/10 transition-colors">Floor</button>
                        <button onClick={() => setSellPriceBsd(Math.ceil(floorBsd * 1.05).toString())}
                          className="px-2.5 py-1.5 min-h-[44px] rounded-lg bg-surface-base border border-white/10 text-[10px] font-bold text-white/50 hover:text-white hover:bg-white/10 transition-colors">+5%</button>
                        <button onClick={() => setSellPriceBsd(Math.ceil(floorBsd * 1.10).toString())}
                          className="px-2.5 py-1.5 min-h-[44px] rounded-lg bg-surface-base border border-white/10 text-[10px] font-bold text-white/50 hover:text-white hover:bg-white/10 transition-colors">+10%</button>
                        <span className="text-[10px] text-white/25 ml-1">Floor: {fmtScout(floorBsd)}</span>
                      </div>
                    </div>
                  )}
                </div>
                  ...
                  return (
                    <div className="bg-black/20 rounded-lg px-3 py-2 space-y-1.5">
                      <div className="flex items-center justify-between text-xs">
                        ...
                        <span className="font-mono tabular-nums text-white/40">{fmtScout(gross)} CR</span>
                      </div>
                      <div className="flex items-center justify-between text-xs">
