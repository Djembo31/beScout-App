          ...
          <>
            <div className="bg-sky-500/10 border border-sky-500/20 rounded-xl p-3">
              <div className="flex items-center justify-between">
                ...
                <span className="font-mono font-black tabular-nums text-lg text-gold">{fmtScout(floorBsd)} bCredits</span>
              </div>
            ...
            <div className="bg-black/20 rounded-xl p-4 space-y-2">
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="font-mono tabular-nums text-white/60">{fmtScout(floorBsd)} bCredits</span>
              </div>
              {buyQty > 1 && (
                <div className="flex items-center justify-between text-xs">
              ...
              {balanceCents !== null && (
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className={`font-mono font-bold tabular-nums ${canAfford ? 'text-green-500' : 'text-red-400'}`}>
                    {formatScout(balanceCents - floorCents * buyQty)} bCredits
                  </span>
                </div>
              )}
            </div>
