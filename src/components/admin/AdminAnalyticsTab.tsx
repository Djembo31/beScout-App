        ...
        {loading ? (
          ...
          <div className="space-y-1">
            ...
            {data.topFans.map((fan, idx) => (
              <div key={fan.user_id} className="grid grid-cols-12 gap-2 items-center px-3 py-2.5 bg-surface-minimal rounded-xl border border-white/[0.04] hover:bg-surface-subtle transition-colors">
