...
export default function MarketFilters({ showTransferFilters }: MarketFiltersProps) {
  ...
  return (
    <div className="space-y-3 mb-4">
      ...
      {/* Expanded filters */}
      {expanded && (
        <div className="bg-surface-subtle border border-white/[0.08] rounded-xl p-3 space-y-3 anim-fade">
          {/* L5 */}
          <div>
          ...
          {showTransferFilters && (
            <div className="border-t border-white/[0.06] pt-3 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <div className="text-[10px] text-white/40 mb-1">{t('priceMin', { defaultMessage: 'Preis min. (bCredits)' })}</div>
                  <input
                    type="number"
                    inputMode="numeric"
                ...
                <div>
                  <div className="text-[10px] text-white/40 mb-1">{t('priceMax', { defaultMessage: 'Preis max. (bCredits)' })}</div>
                  <input
                    type="number"
                    inputMode="numeric"
