...
// Slice 199 C-05 — Top-Predictor Leaderboard service moved to canonical
// location at `@/lib/services/leaderboards` (cross-domain leaderboards module).
// `TopPredictorEntry` (typed UserTier) is the canonical type going forward.
