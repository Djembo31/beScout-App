...
export const qk = {
  ...
  watchlist: {
    ...
    watcherCount: (playerId: string) => ['watchlist', 'watcherCount', playerId] as const,
  },
  ...
  social: {
    ...
    isFollowing: (followerId: string, followingId: string) => ['social', 'isFollowing', followerId, followingId] as const,
