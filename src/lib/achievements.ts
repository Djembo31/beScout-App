...
const HIDDEN_FALLBACK: AchievementDef[] = [
  ...
  { key: 'diamond_hands', label: 'Treuer Sammler', description: 'Scout Card 30 Tage gehalten ohne zu verkaufen', label_tr: 'Sadık Koleksiyoncu', description_tr: "Scout Card'yi satmadan 30 gün tutma", icon: '⏳', category: 'trading', featured: false },
