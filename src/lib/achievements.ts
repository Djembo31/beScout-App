...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  { key: 'sell_order', label: 'Erstverkauf', description: 'Ersten Sell-Order erstellt', icon: '🏷️', category: 'trading' },
  // Manager
  { key: 'first_event', label: 'Debüt', description: 'Erstes Fantasy-Event gespielt', icon: '⚽', category: 'manager' },
  { key: '3_events', label: 'Spieltag-Fan', description: '3 Fantasy-Events gespielt', icon: '📅', category: 'manager' },
  ...
  // Scout
  { key: 'verified', label: 'Verifiziert', description: 'Profil verifiziert', icon: '✅', category: 'scout' },
  { key: 'first_post', label: 'Erste Meinung', description: 'Ersten Community-Post geschrieben', icon: '✍️', category: 'scout' },
  { key: 'first_research', label: 'Analyst', description: 'Erste Research-Analyse veröffentlicht', icon: '🔬', category: 'scout' },
  { key: 'research_sold', label: 'Bestseller', description: 'Erste Research-Analyse verkauft', icon: '💎', category: 'scout' },
  { key: '10_upvotes', label: 'Meinungsführer', description: '10 Upvotes auf Posts erhalten', icon: '🔥', category: 'scout' },
